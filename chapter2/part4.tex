...
The initial characterization of the resonator is performed at zero magnetic field using a Vector Network Analyzer in the reflection configuration. \reffig{resonator_fit}a shows the complex reflection parameter as a function of frequency. By fitting the model we obtain the internal and coupling losses of the resonator, $\kappa_i/2\pi=320$~kHz and $\kappa_c/2\pi = 420$~kHz.

\begin{figure}
    \includegraphics{chapter2/figures/resonator_fit.pdf}
    \caption[Resonator fit]{Resonator fit and field responds. 
    \textbf{a.} Reflection signal of the resonator at zero magnetic field. The data is fit to a standard reflection model (black lines) which yields $\omega_r/2\pi=7.74845$~GHz and a quality factor of $Q\approx10^5$.
    \textbf{b.} Magnetic field response of the resonator. Frequency and quality factor as a function of in-plane magnetic field amplitude. The data was taken in transmission mode. \red{there is a discrepancy between a and b. Find data from the same run}
    }
...
For an in-plane field, the resonance frequency exhibits a characteristic shift, while the quality factor remains relatively robust up to higher field magnitudes, as illustrated in \reffig{resonator_fit}b. In contrast, the resonator response to an out-of-plane field component is considerably more dramatic, even a marginal perpendicular component of $B_{0}$ can lead to significant inductive shifts and enhanced dissipative losses. 
