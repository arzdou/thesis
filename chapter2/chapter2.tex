...
We now proceed to describe the individual components of the SMPD. \reffig{SMPD_micrograph} is a false color micrograph of the device and \reffig{SMPD_circuit} shows a schematic representation of the circuit. 

\begin{enumerate}
    \item \textbf{Qubit}
    \item \textbf{Buffer}
    \item \textbf{Purcell filter of the buffer}
    \item \textbf{Waste}
    \item \textbf{Purcell filter of the waste}
    \item \textbf{Qubit drive line}
\end{enumerate}

\begin{figure*}
    \includegraphics{chapter2/figures/SMPD.pdf}
    \caption[SMPD circuit]{SMPD circuit. \red{write text, check what you need and do caption}}
    \labfig{SMPD_circuit}
\end{figure*}
